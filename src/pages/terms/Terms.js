...
const Terms = () => {
          ...
          <ul role="list" className={styles.termslist}>
            <li className={styles.termslistitem}>
              <p className={styles.p2}>
                Welcome to TEDxSydney Limited (ACN 164 042 746) Suite 103, Level 1, 165 Walker Street, North Sydney NSW 2059
                (<b>we</b>,<b> us </b>or<b> our</b>).<span className="Apple-converted-space">&nbsp; </span>By registering as a
                member of the TEDxSydney community, registering for and paying for attendance at TEDxSydney events (<b>Event(s)</b>),
      ...
      <div className={styles.termtextwrapper}>
        <ul role="list" className={styles.termslist}>
          <li className={styles.termslistitem}>
            ...
            <ul>
              <li>
                (a) <a href="about:blank"><span className="s2">register</span></a> as a member of the TEDxSydney community;
              </li>
              <li>(b) register for and pay for attendance at Events; and</li>
              <li>
                (c) access:
                <ul className="ul1">
                  <li className="li2">(i) inspiring, innovative and educational talks; and</li>
    ...
    <div className={styles.contentblock}>
      <h2 className={styles.h2term}>Your account </h2>
      <div className={styles.termtextwrapper}>
        <ul role="list" className={styles.termslist}>
          <li className={styles.termslistitem}>
            <p className={styles.p2}> In order to access certain features of the Services, you must set up an account. You must be over 13 years of age to set up an account.<span className="Apple-converted-space">&nbsp; </span>Once <a href="https://tedxsydney.com/community/"><span className="s2">registered</span></a>, please feel free to set up a profile and join the community in commenting on TEDxSydney talks and news items, or by registering to attend one of our Events.&nbsp;</p>
          </li>
          <li className={styles.termslistitem}>
            <p className={styles.p2}> You agree and acknowledge that all information you provide us will be true, accurate, current and complete and you must not create an account for anyone other than yourself.&nbsp;</p>
          </li>
          <li className={styles.termslistitem}>
            <p className={styles.p2}> You are solely responsible for maintaining the confidentiality and security of your account and all activities on or through your account.&nbsp;</p>
          </li>
          <li className={styles.termslistitem}>
            <p className={styles.p2}> You must notify us immediately of any unauthorised use of your account. We are not liable for any loss or damage arising in connection with any unauthorised use of your account.&nbsp;</p>
          </li>
          <li className={styles.termslistitem}>
            <p className={styles.p2}> You may cancel your account for any reason by notifying us.&nbsp;</p>
          </li>
          <li className={styles.termslistitem}>
            <p className={styles.p2}> We may reject account set up, disable, suspend, or cancel your account if you fail to comply with your obligations under these terms or use or if we suspect there is unauthorised use of your account.&nbsp;</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div className={styles.contentblock}>
      ...
      <div className={styles.termtextwrapper}>
        <ul role="list" className={styles.termslist}>
          <li className={styles.termslistitem}>
            <p className={styles.p2}>You are responsible for any content that you submit, post or display on or through your account and/or the Services, including data, text, files, information, usernames, photos, profiles, audio and video clips, works of authorship, applications, links and other materials (User Content).</p>
          </li>
          <li className={styles.termslistitem}>
          ...
          <li className={styles.termslistitem}>
            <p className={styles.p2}> You must respect that other people in the TEDxSydney community have had different life experiences and may have a different perspective to yours. We welcome different viewpoints.</p>
          </li>
          <li className={styles.termslistitem}>
    ...
    <div className={styles.contentblock}>
      ...
      <div className={styles.termtextwrapper}>
        <ul role="list" className={styles.termslist}>
          ...
          <li className={styles.termslistitem}>
            <p className={styles.p2}>
              Subject to clause 5.1, we own, or are the licensee of, the intellectual property rights in the content
        ...
        <ul role="list" className={styles.termslist}>
          <li className={styles.termslistitem}>
            <p className={styles.p2}>
              ...
              you use the Services will be subject to our <a href="https://tedxsydney.com/privacy/"><span
    ...
    <div className={styles.contentblock}>
      ...
      <div className={styles.termtextwrapper}>
        <ul role="list" className={styles.termslist}>
          <li className={styles.termslistitem}>
            <p className={styles.p2}>From time to time we may host physical or digital TEDxSydney events (<strong>Event</strong>).</p>
          </li>
          <li className={styles.termslistitem}>
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>(i) register via <a href="https://tedxsydney.com/community/">tedxsydney.com/community/</a> to become a member of the TEDxSydney community;</li>
            ...
            <li>(b) a digital Event, you must be 13 years of age or older; or</li>
            <li>
              (c) a physical Event:
              <ul>
                <li>(i) be 15 years of age or older, or if you are under 15 years of age and it is a physical Event, be accompanied by an adult over 18 years old who has also registered to attend the Event;</li>
      ...
      <div className={styles.termtextwrapper}>
        <ul role="list" className={styles.termslist}>
          <li className={styles.termslistitem}>
            ...
            <ul>
              <li>(a) the transferee meets the requirements in clause 2, including registering via <a href="https://tedxsydney.com/community/">tedxsydney.com/community/</a> to become a member of the TEDxSydney community; and</li>
              <li>(b) you submit your transfer request by emailing us at info@tedxsydney.com at least 2 full days before the Event.</li>
            </ul>
          </li>
          <li className={styles.termslistitem}>
          ...
          <li className={styles.termslistitem}>
            ...
            <ul>
              ...
              <li>(c) If we cancel, reschedule, or reframe the delivery of an Event due to government restrictions or mandates arising as a result of COVID-19 (and/or any other cause independent of human control), we will outline the options that we are able to offer in respect of your registration at that time, taking into account guidance provided by the Australian Competition & Consumer Commission (available <a href="https://www.accc.gov.au/consumers/consumer-rights-guarantees/covid-19-coronavirus-information-for-consumers">here</a>).</li>
              <li>(d) For the reasons explained in clause 2, save for where we are required to provide a refund under the Australian Consumer Law or other applicable Australian law, our tickets are generally non-refundable.</li>
              <li>(e) You can contact us at <a href="mailto:audience@tedxsydney.com">audience@tedxsydney.com</a> for further assistance in relation to your registration.</li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div className={styles.contentblock}>
      ...
      <div className={styles.termtextwrapper}>
        <ul role="list" className={styles.termslist}>
          <li className={styles.termslistitem}>
            <p className={styles.p2}>TEDxSydney is built around a spirit of curiosity, open-mindedness, respect, and tolerance, and we do not tolerate harassment in any form.</p>
          </li>
          <li className={styles.termslistitem}>
            <p className={styles.p2}>As a member of the TEDxSydney community and Event attendee, you’re expected to practice tolerance and respect for everyone, including other attendees, staff, volunteers, and vendors, regardless of their background, class, political views, or status.</p>
          </li>
          <li className={styles.termslistitem}>
          ...
          <li className={styles.termslistitem}>
            <p className={styles.p2}>If, while at an Event, you have been involved in or have witnessed an incident that violates this attendee code of conduct, please report it as soon as possible to a TEDxSydney team member. Team members are onsite at our customer service and registration desks. Alternatively, you can use our <a href="https://goo.gl/forms/a"><span className="s2">name-optional reporting form</span></a> to let our TEDxSydney team know about an incident. Share as much information as you can to help us with any investigation of the incident.</p>
          </li>
          <li className={styles.termslistitem}>
    ...
    <div className={styles.contentblock}>
      ...
      <div className={styles.termtextwrapper}>
        <ul role="list" className={styles.termslist}>
          <li className={styles.termslistitem}>
            <p className={styles.p2}>Your use of the Services and attendance at an Event is entirely at your own risk. Notwithstanding anything else in this agreement, we accept no liability for any decisions made by you, as a result of your use of the Services or attendance at an Event.</p>
          </li>
          <li className={styles.termslistitem}>
          ...
          <li className={styles.termslistitem}>
            <p>Nothing contained in these Terms restricts or modifies any guarantee, right or remedy which pursuant to the Australian Consumer Law applies to these Terms or is conferred on you.</p>
          </li>
          <li className={styles.termslistitem}>
            <p>To the extent that the Australian Consumer Law permits, TEDxSydney’s liability for its failure to comply with a guarantee imposed by the Australian Consumer Law is limited to:</p>
            <ul>
          ...
          <li className={styles.termslistitem}>
            ...
            <ul>
              ...
              <li>(b) “Australian Consumer Law” means the provisions of Schedule 2 to the Competition and Consumer Act 2010 (Cth), as applied under Part XI or under a law of a State or Territory.</li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <div className={styles.contentblock}>
      ...
      <div className={styles.termtextwrapper}>
        <ul role="list" className={styles.termslist}>
          <li className={styles.termslistitem}>
            <p className={styles.p2}>Notices required to be given under these Terms may be sent by email to <a href="mailto:info@tedxsydney.com"><span className="s2">info@tedxsydney.com</span></a>.&nbsp;</p>
          </li>
          <li className={styles.termslistitem}>
          ...
          <li className={styles.termslistitem}>
            <p className={styles.p2}>These Terms are governed by the laws of New South Wales, Australia. You agree to submit to the non-exclusive jurisdiction of the courts of the State of New South Wales to resolve any dispute or claim arising from these Terms.&nbsp;</p>
          </li>
          <p className={styles.p2}><em>These terms were updated on 9 November 2021.</em></p>
        </ul>
      </div>
    </div>
    </div>
